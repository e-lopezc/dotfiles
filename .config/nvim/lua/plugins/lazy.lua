        ...
        require('mason-lspconfig').setup({
          ...
          require('lspconfig').pyright.setup {
            ...
            before_init = function(_, config)
              -- default_venv_path = path.join(vim.env.HOME, vim.env.VIRTUAL_ENV, "pyenv-virtualenv", "bin", "python")
              config.settings.python.pythonPath = get_python_path(config.root_dir)--default_venv_path
            end,
          }
        end
